...
<body>
    <div>
        <div class="h-screen flex justify-center items-center bg-cover bg-center"
            ...
            <a href="index.html"
                class="absolute bg-red-600 hover:bg-red-700 text-white p-3 top-0 right-0 mt-3 mr-5">Sign In</a>
            <div class="space-y-5">
                ...
                <div class="flex flex-row items-center justify-center">
                    <form id="searchForm" action="/DS_Group7/Main" method="POST">
                        ...
                        <button type="submit"
                            class="p-4 text-l font-semibold bg-red-600 hover:bg-red-700 text-white">Search
                            ></button>
                    </form>
                </div>
